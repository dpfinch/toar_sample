...
def output_to_file(config_vars, sat_data):
    ...
    outfilename = 'Satellte_Sampled_Model_{}_{}.nc'.format(first_time_str,last_time_str)
    ...
    levs = outfile.createVariable('Levels','f8',('Levels',))
